...
if(empty($_SESSION["blood"])) // Destroying All Sessions
{
header("Location: ../view/find.php"); // Redirecting To Home Page
}
           ...
           <td width="95%">
            ...
            <table width="100%" border="2" bgcolor="white">
                <tr>
                    <td>
                        <br>
                        <h3><?php echo "Your search blood group is  : ". $_SESSION["blood"]; ?> </h3>
                        <br>
                    ...
                    { 
                        ...
                        echo "  <td>".$myobj->caddress."  </td>";
                        echo "  <td>".$myobj->occupation."  </td>";
                        ...
                        {
                            //echo "No blood group matched. <br>";
                        }
